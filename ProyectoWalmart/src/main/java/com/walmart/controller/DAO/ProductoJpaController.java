package com.walmart.controller.DAO;

import com.walmart.controller.DAO.exceptions.NonexistentEntityException;
...
public class ProductoJpaController implements Serializable {
    ...
    public void editProduct(Producto producto) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
